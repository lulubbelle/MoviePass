                ...
                <div class="col-md-3">
                    <div class="form-content">
                        <div class="form-group">
                            <a href="<?= FRONT_ROOT ?>Cinema/RoomAddView?cineId=<?=$cineId?>" class="btn btn-success">Agregar</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        ?>
                            ...
                            <div class="cinema-item">
                                ...
                                <div class="column-2">
                                    ...
                                    <a type="button" class="btn btn-info btn-abm-cinema" href="<?= FRONT_ROOT ?>Cinema/UpdateRoomShowView?id=<?=$key->getId()?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
