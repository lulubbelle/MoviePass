                        ...
                        ?>
                            ...
                            <div class="cinema-item">
                                <div class="column-1">
                                    <h3><?= $key->getNombre() ?></h3>
                                    <br/>
                                    <h3>Valor Entrada: <?= $key->getValorEntrada() ?></h3>
                                    <br/>
                                ...
                                <div class="column-2">
                                    <a type="button" class="btn btn-danger btn-abm-cinema" href="<?= FRONT_ROOT ?>Cinema/DeleteCinema">
                                    ...
                                    <a type="button" class="btn btn-info btn-abm-cinema" href="<?= FRONT_ROOT ?>Cinema/UpdateCinema">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
