            ...
            <form action="<?= FRONT_ROOT ?>Cinema/CinemaSearch" method="POST" class="cinema-form">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-3">
                        <div class="form-content">
                            <div class="form-group">
                                <a href="<?= FRONT_ROOT ?>Cinema/CinemaAddView" class="btn btn-success">Agregar Cine</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="cinema-list">
                            ...
                            ?>
                                    ...
                                    <div class="cinema-item">
                                        ...
                                        <div class="column-2">
                                            <a type="button" class="btn btn-success btn-abm-cinema" title="Agregar Salas" href="<?= FRONT_ROOT ?>Cinema/RoomListShowView?cineId=<?= $key->getId() ?>">
                                            ...
                                            <a type="button" class="btn btn-danger btn-abm-cinema" title="Eliminar Cine" href="<?= FRONT_ROOT ?>Cinema/DeleteCinema?id=<?= $key->getId() ?>">
                                            ...
                                            <a type="button" class="btn btn-info btn-abm-cinema" title="Editar Cine" href="<?= FRONT_ROOT ?>Cinema/UpdateCinemaShowView?id=<?= $key->getId() ?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
